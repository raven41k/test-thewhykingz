...
const HomePage = () => {
    ...
    return (
        <div>
            ...
            <img
                src="https://picsum.photos/800/198/?random"
                alt=""
                className="main__img-mob"
            />
            <section className="featured">
                ...
                <nav className="featured__list">
                    ...
                    <a className="featured__list__item" href="#">
                        <img
                            className="featured__list__item__photo"
                            src="https://picsum.photos/800/205/?random"
                            alt=""
                        />
                        <span className="featured__list__item__name">NAO</span>
                        <span className="featured__list__item__subname">
                    ...
                    <a className="featured__list__item" href="#">
                        <img
                            className="featured__list__item__photo"
                            src="https://picsum.photos/800/209/?random"
                            alt=""
                        />
                        <span className="featured__list__item__name">NAO</span>
                        <span className="featured__list__item__subname">
                    ...
                    <a className="featured__list__item" href="#">
                        <img
                            className="featured__list__item__photo"
                            src="https://picsum.photos/800/777/?random"
                            alt=""
                        />
                        <span className="featured__list__item__name">NAO</span>
                        <span className="featured__list__item__subname">
                    ...
                    <a className="featured__list__item" href="#">
                        <img
                            className="featured__list__item__photo"
                            src="https://picsum.photos/800/155/?random"
                            alt=""
                        />
                        <span className="featured__list__item__name">NAO</span>
                        <span className="featured__list__item__subname">
