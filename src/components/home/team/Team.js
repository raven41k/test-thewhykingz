...
import {fetchTeam, resetSearch, setLoading} from '../../../redux/actions/searchActions';
                ...
                <div className="left-section__list">
                    <ul>
                        <li className='left-section__list__item'>
                            <img className='left-section__list__item__photo' src="https://picsum.photos/800/201/?random" alt=""/>
                            <div className="left-section__list__item__desc">
                                <div className="left-section__list__item__desc__name">Firestarter</div>
                                <div className="left-section__list__item__desc__small-name">The Prodigy</div>
                            </div>
                            <time className='left-section__list__item__time'>4:22</time>
                            <button className='left-section__list__item__btn'>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#5ABC61" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
